...
import { type EChartsType, type ComposeOption, graphic, init, use } from 'echarts/core';
...
type NodeChartOption = ComposeOption<PieSeriesOption | TooltipComponentOption | LegendComponentOption>;
